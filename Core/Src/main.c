...
static const man_runtime_config_t man_cfg = {
    .encoding = MAN_ENCODING_STANDARD, /* или MAN_ENCODING_STANDARD MAN_ENCODING_DIFFERENTIAL */
    .transfer_mode = MAN_MODE_SINGLE,      /* или MAN_MODE_SINGLE */
...
static const man_platform_t man_hw = {
    ...
    .led_tx_pin = LD2_Pin,
    .led_error_port = LD3_GPIO_Port,
    .led_error_pin = LD3_Pin,
    .dbg_rx_port = DBG_RX_GPIO_Port,
    .dbg_rx_pin = DBG_RX_Pin,
    .dbg_tx_port = DBG_TX_GPIO_Port,
    .dbg_tx_pin = DBG_TX_Pin,
...
int main(void)
{
  ...
  /* add threads, ... */
  if (!Manchester_CreateRtosObjects()) {
      Error_Handler();
  }
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, Manchester_TX_Pin|DBG_RX_Pin|DBG_TX_Pin, GPIO_PIN_RESET);
...
void Error_Handler(void)
{
  /* USER CODE BEGIN Error_Handler_Debug */
	HAL_GPIO_WritePin(DBG_ERR_GPIO_Port, DBG_ERR_Pin, GPIO_PIN_SET);
